...
- **Examples:** [`openapi-examples.yaml`](./openapi-examples.yaml) · **Errors:** [`puls-error-catalog.md`](./puls-error-catalog.md)
- **Validation:** [`openapi-validation.md`](./openapi-validation.md) · [`openapi-contract-allowlist.json`](./openapi-contract-allowlist.json) · [`12_mutation_contract_smoke_hardening.md`](./12_mutation_contract_smoke_hardening.md)
