...
| [PR17.2G4C OCR Local Extraction Benchmark](./17_2_g4c_expense_receipt_ocr_local_extraction_benchmark.md) | Completed local `pdf_text` extraction route, Turkish amount/date parser, synthetic fixture contract, network-free benchmark runner, and G4C-A hardening; no paid provider or customer dataset.               |
...
Reference: [17_0_product_reality_audit.md](./17_0_product_reality_audit.md) Rev 21.
