...
export {
  ...
  type EmployeeAssignmentErrorMapping,
  type EmployeeAssignmentMutationInput,
  type EmployeeAssignmentUpdateResult,
...
export {
  ...
  type EmployeeAssignmentCostCenterOption,
  type EmployeeAssignmentDepartmentOption,
  type EmployeeAssignmentEditOptions,
  type EmployeeAssignmentEntityRef,
  type EmployeeAssignmentManagerRef,
  type EmployeeAssignmentManagerOption,
  type EmployeeAssignmentPositionOption,
