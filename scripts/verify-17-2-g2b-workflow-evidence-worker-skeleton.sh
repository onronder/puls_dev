...
require_pattern "$DOC" "heartbeat_expense_receipt_ocr_job"
...
require_pattern "$AUDIT" "browser enqueue, Railway deploy, canonical expense write ve paid OCR/VLM provider hâlâ kapalı"
